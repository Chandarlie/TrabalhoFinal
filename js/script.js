...
function compararPlanos(aBasico, aStandard, aPremium, bBasico, bStandard, bPremium) {
    ...
    if (menorPreco == aBasico) {
        planoMaisVantajoso = "Básico do convenio A";
    } else if (menorPreco == aStandard) {
        planoMaisVantajoso = "Standard do convenio A";
    } else if (menorPreco == aPremium) {
        planoMaisVantajoso = "Premium do convenio A";
    } else if (menorPreco == bBasico) {
        planoMaisVantajoso = "Básico do convenio B";
    } else if (menorPreco == bStandard) {
        planoMaisVantajoso = "Standard do convenio B";
    } else {
        planoMaisVantajoso = "Premium do convenio B";
    }
